...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <form action="{{ url('updatecategory') }}" method="PUT" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ $category->name }}" class="form-control" id="exampleFormControlInput1" placeholder="name"
                                       name="name"/>
                            </div>
                            <div class="mb-3">
